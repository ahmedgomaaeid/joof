...
<div class="main-content app-content mt-0">
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                            <form method="post" action="{{route('post.admin.edit.category',$category->id)}}" enctype= "multipart/form-data">
                            @csrf
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-9">
                                                <textarea name="text" id="editor" class="form-control" placeholder="نص القسم" style="text-align:right;">{{$category->text}}</textarea>
                                                @error('text')
                                                    <div class="invalid-feedback" style="display:block;">{{$message}}</div>
                                                @enderror
