...
<head>
    ...
    <!-- FAVICON -->
    <link rel="shortcut icon" type="image/x-icon" href="{{route('index')}}/../webassets/imgs/logo.png" />
                ...
                <div class="container-fluid main-container">
                    <div class="d-flex">
                        ...
                        <a class="logo-horizontal " href="{{route('admin.index')}}">
                            ...
                            <img src="{{route('index')}}/../webassets/imgs/logo.png" class="header-brand-img light-logo1"
                                alt="logo" style="max-width: 68px;">
                        </a>
                        <!-- LOGO -->
                    </div>
                </div>
                ...
                <div class="app-sidebar">
                    <div class="side-header">
                        <a class="header-brand1" href="{{route('admin.index')}}">
                            ...
                            <img src="{{route('index')}}/../assets/images/brand/logo-1.png" class="header-brand-img toggle-logo"
                                alt="logo">
                            <img src="{{route('index')}}/../webassets/imgs/logo.png" class="header-brand-img light-logo" alt="logo">
                            <img src="{{route('index')}}/../webassets/imgs/logo.png" class="header-brand-img light-logo1"
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{route('admin.index')}}"><i
                                        class="side-menu__icon fa fa-universal-access"></i><span
                                        class="side-menu__label">المشرفون</span></a>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{route('admin.articles')}}"><i
                                        class="side-menu__icon fa fa-newspaper-o"></i><span
                                        class="side-menu__label">الاخبار</span></a>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{route('admin.category')}}"><i
                                        class="side-menu__icon fe fe-package"></i><span
                                        class="side-menu__label">الاقسام</span></a>
                            </li>
                            <li class="slide">
